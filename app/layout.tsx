...
import { Archivo_Black, Space_Grotesk, Playfair_Display, Inter } from 'next/font/google';
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="pt-BR" className={`${archivo.variable} ${grotesk.variable} ${playfair.variable} ${inter.variable}`}>
